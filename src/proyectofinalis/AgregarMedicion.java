 ...
 */
public class AgregarMedicion extends javax.swing.JFrame {

    /**
     * Creates new form AgregarMedicion
     */
    public AgregarMedicion() {
        initComponents();
        this.setTitle("Agregar Medicion");
...
//        setSize(width/2, height/2);		
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarMedicion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarMedicion().setVisible(true);
            }
        });
    }
