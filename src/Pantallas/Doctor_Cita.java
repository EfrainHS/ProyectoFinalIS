 ...
 * @author EfrainHS
 */
public class Doctor_Cita extends javax.swing.JFrame {
    ...
    void cargarLista(){
        List<Doctor> lista = ser.login("http://localhost:8084/EasyNutritionService/webresources/Nutrition/getDoctores");
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        CrearCita.txt_iddoctor.setText(nom +" "+ ape);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Doctor_Cita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Doctor_Cita().setVisible(true);
            }
        });
    }
